...
void main() {
  group('HomeScreen SenseBox Selection Button Tests', () {
    testWidgets('home screen can be built without errors', (WidgetTester tester) async {
    ...
    testWidgets('theme colors are defined correctly',
      ...
      expect(loginRequiredColor, const Color(0xFF8B0000)); // Dark red
      expect(loginRequiredTextColor, Colors.white);
    });

    testWidgets('text styling has reduced line height', (WidgetTester tester) async {
    ...
    testWidgets('settings screen can be imported and used', (WidgetTester tester) async {
