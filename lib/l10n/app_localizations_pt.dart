...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get errorDirectUploadFailed => 'O upload em tempo real falhou devido a problemas de conectividade. Não se preocupe – seus dados foram salvos localmente. Após parar a gravação, você pode enviar o trajeto manualmente na tela de visão geral dos trajetos.';
