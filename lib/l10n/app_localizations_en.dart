...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get trackUploadLoginSelectHint => 'Log in and select a senseBox to upload.';

  @override
  String get uploadRequirementsTitle => 'Upload not available';

  @override
  String get uploadPostRideRequirementsMessage => 'To upload your ride, log in to your openSenseMap account, select a senseBox, then open the track overview and tap the upload button in the top right.';
