  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: ConstrainedBox(
        // Tight width so children (Rows, Expanded) always get bounded
        // constraints; Dialog itself hands down an unbounded width.
        constraints: BoxConstraints.tightFor(width: targetMaxWidth),
        child: Column(
